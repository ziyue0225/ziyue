...
itemList = \
 ...
 [1, 0, 'Tanguturu', 14.5, 5.3, 6600, 2, 1.0],
 [2, 0, 'Podili', 10.7, 7.0, 24000, 2, 500],
 [3, 0, 'Ongole', 14.5, 6.2, 305000, 4, 200],
 [4, 0, 'Markapur', 7.7, 8.2, 60000, 2, 0.5],
 [5, 0, 'KaniGiri', 9.6, 5.1, 24000, 2, 300],
 [6, 0, 'Kondukur', 13.2, 3.5, 90000, 2, 1.0],
 [7, 0, 'Giddalur', 3.8, 5.0, 25000, 2, 1.0],
 [8, 0, 'Chirala', 17.2, 9.0, 98000, 4, 600],
 [9, 0, 'Bestavapetta', 6.3, 6.3, 25000, 2, 400],
 [10, 0, 'Addanki', 13.9, 8.8, 60000, 2, 0.5],
 [11, 0 , 'Chilakalurupet', 15.4, 11.4, 92000, 2, 1.0],
 [12, 0, 'Narasaraopet', 14.5, 12.5, 100000, 4, 1.0],
 [13, 0, 'Vinukonda', 11.8, 11.0, 65000, 2, 1.0],
 [14, 0, 'Tadikonda', 18.1, 14.3, 60000, 2, 1.0],
 [15, 0, 'Sattenapalle', 15.2, 14.0, 45000, 2, 1.0],
 [16, 0, 'Repalie', 21.3, 10.6, 50000, 2, 1.0],
 [17, 0, 'Guntur', 18.0, 13.0, 450000, 4, 3.0],
 [18, 0, 'Vuyyuru', 21.3, 13.6, 39000, 4, 341.0],
 [19, 0, 'Tenali', 19.7, 12.5, 140000, 4, 1.0],
 [20, 0, 'Pamarru', 22.3, 13.2, 62000, 2, 1.0],
 [21, 0, 'Nuzvid', 21.3, 17.5, 37000, 2, 500],
 [22, 0, 'Machilipatnam', 23.8, 12.0, 108000, 4, 1.0],
 [23, 0, 'Kaikalur', 24.4, 15.5, 48000, 2, 1.0],
 [24, 0, 'Jaggayyapeta', 14.9, 18.5, 37000, 2, 0.5],
 [25, 0, 'HanumenJunction', 19.5, 15.2, 50000, 2, 1.0],
 [26, 0, 'Gudivada', 22.7, 14.3, 180000, 2, 1.0],
 [27, 0, 'Bapatia', 18.2, 9.7, 82000, 2, 1.0],
 [28, 0, 'Rajahmundry', 29.5, 19.6, 470000, 4, 3.5],
 [29, 0, 'Mandapeta', 30.8, 18.3, 170000, 2, 2.0],
 [30, 0, 'Narasapur', 28.7, 14.5, 160000, 2, 1.0],
 [31, 0, 'Amaiapuram', 31.5, 15.6, 90000, 2, 1.0],
 [32, 0, 'Kakinada', 33.5, 19.1, 228000, 4, 2.0],
 [33, 0, 'Kovvur', 29.0, 19.7, 45000, 2, 1.0],
 [34, 0, 'Tanuku', 28.8, 17.4, 134000, 2, 1.0],
 [35, 0, 'Nidavole', 28.5, 18.7, 50000, 2, 1.0],
 [36, 0, 'Tadepallegudem', 27.7, 17.9, 130000, 4, 1.5],
 [37, 0, 'Eluru', 23.6, 17.0, 198000, 4, 2.0],
 [38, 0, 'Palakolu', 25.9, 15.7, 180000, 4, 1.0],
 [39, 0, 'Bhimavaram', 27.3, 15.3, 148000, 4, 1.5]]
