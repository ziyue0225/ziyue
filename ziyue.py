...
itemList = \
 ...
 [2, 0, 'Podili', 10.7, 7.0, 24000, 2, 0.5],
 [3, 0, 'Ongole', 14.5, 6.2, 305000, 4, 2.5],
 [4, 0, 'Markapur', 7.7, 8.2, 60000, 2, 0.5],
 [5, 0, 'KaniGiri', 9.6, 5.1, 24000, 2, 2.5],
 [6, 0, 'Kondukur', 13.2, 3.5, 90000, 2, 1.0],
 [7, 0, 'Giddalur', 3.8, 5.0, 25000, 2, 1.0],
 [8, 0, 'Chirala', 17.2, 9.0, 98000, 4, 2.0],
 [9, 0, 'Bestavapetta', 6.3, 6.3, 25000, 2, 0.5],
